...
const init =()=>{
    ...
    const clickSubmit = e =>{
        ...
        // setSuccess(false);
        // make request to create prodcut 
        ...
        <form onSubmit={clickSubmit} className='mb-3'>
            <div className='from-group'>
                ...
                <label className='btn btn-secondary' >
                 <input onChange={handleChange('photo')}  type='file'  name='photo' className='form-control ' accept='image/*' />
                </label>                
            </div>
    ...
    const showLoading = () => (
        loading && (
            <div className='alert alert-successs'>
                <h2>Loading.....</h2>
            </div>
        )
    )
